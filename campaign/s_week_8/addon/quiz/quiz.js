...
function quiz_show(num) { //num번째 문제 보여주기
    ...
    if(currChasi==1 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',320); /* 보기 전체 위치 수정 */
    if(currChasi==1 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',320); /* 보기 전체 위치 수정 */
    if(currChasi==1 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',320); /* 보기 전체 위치 수정 */
...
function quiz_confirm() {
    ...
    function show_answer() {
        ...
        /* 객관식 */
            ...
            if(answer == 3) answer = '③';
            if(answer == 4) answer = '④';
            $("#quiz-wrapper>#quiz-content>.answer-wrapper>.answer-answer").text(answer + '번입니다.');
        }
        /* 주관식 */
