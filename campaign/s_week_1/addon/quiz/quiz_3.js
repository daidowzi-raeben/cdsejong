...
function quiz_show(num) { //num번째 문제 보여주기
	...
	/* 퀴즈 보기 위치 300-400, 360-150 */
    $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top','');
    if(currChasi==1 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',360);
    if(currChasi==1 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',360);
    if(currChasi==1 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',360);
