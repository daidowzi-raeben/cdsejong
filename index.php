...
<div class="pledge-modal show" id="isShowModal">
	...
	<div class="pledge-modal--con">
		<div>
			<button
				style="position:fixed;left:50%; margin-left:370px;border:0; background:none; color:#fff; font-size:30px;"
				onclick="javascript:document.getElementById('isShowModal').classList.toggle('show')">X</button>
		</div>
		<div class="con-wrap">
			<div class="header">
				윤리강령 준수 실천 서약서<br />
	...
	<div class="pledge-modal--con">
		...
		<div class="con-wrap">
			...
			<div class="content">
				...
				<p>
					2. 주어진 권한과 책임하에 직무에 최선을 다하며, 제반법규와 규정 제도를 준수하고 개인적 이익을 위해 직권남용, 허위, 과장, 은폐, 누설 행위 등을 하지 않고 임직원 상호간에
					인권과 인격을 존중하며 예의 바르고 성실하게 업무에 임 하겠습니다.
				</p>
				<p>
