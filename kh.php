...
/* 로그인 */
.mem05_skin {width:320px;background:#ffffff;padding-bottom:50px;margin:80px auto 0}
...
<div style="position:absolute;height:493px; top:50%; margin-top:-300px; left:50%; margin-left:-200px;">
	<div style="text-align:center; margin-top:20px;">
		<img src="../img/kh_logo.png" style="max-width:80%">
	</div>
		...
		<div class="inner">
			...
			<form name="flogin" action="/bbs/login_check.php" onsubmit="return flogin_submit(this);" method="post" autocomplete="off">
				<input type="hidden" name="url" value="/Edu/class.php?lssn=88">

				<fieldset id="login_fs">
				<div>
					<legend style="margin:20px;">회원로그인</legend>
					<!-- <label for="login_id" class="sound_only">회원아이디<strong class="sound_only"> 필수</strong></label> -->
					<input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="사번을 입력하세요">
					</div>
					<div>
					<!-- <label for="login_pw" class="sound_only">비밀번호<strong class="sound_only"> 필수</strong></label> -->
					<input type="password" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxLength="20" placeholder="사번을 입력하세요">
	</div>
