...
<title>세종교육원</title>
<style>
body{background:url(<?php echo G5_URL ?>/img_cd/bg.jpg) no-repeat top center;width:100%;}
.login{width:699px; height:391px; margin:300px auto; background:url(<?php echo G5_URL ?>/img_cd/login_box.png) no-repeat; position:relative}
...
.login button{width:90px; height:57px; background:url(<?php echo G5_URL ?>/img_cd/btn_login.jpg) no-repeat; display:block; cursor:pointer; float:right; position:absolute; right:70px; top:98px; border:0px;}
