...
<form name="fmember" id="fmember" action="./member_form_update.php" onsubmit="return fmember_submit(this);"
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row"><label for="mb_10">년도
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                        <input type="text" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input"
                            size="30" maxlength="20">
                    </td>
                    <th scope="row"><label for="mb_1">소속
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                        <input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" class="frm_input"
                            size="30" maxlength="20">
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="mb_level" id="mb_level" class="mb_form">
                            <option value="6" <?php echo $selLv06?>>과정운영자</option>
                            <option value="7" <?php echo $selLv07?>>소속운영자</option>
                            <option value="8" <?php echo $selLv08?>>운영자</option>
                            <option value="9" <?php echo $selLv09?>>관리자</option>
                            <option value="10" <?php echo $selLv10?>>최고관리자</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_id">아이디(사번)
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                        <input type="text" name="mb_id" value="<?php echo $mb['mb_id'] ?>" id="mb_id" <?php echo
                            $required_mb_id ?> class="frm_input
                        <?php echo $required_mb_id_class ?>" size="30" maxlength="20">
                    </td>
                    <th scope="row"><label for="mb_password">비밀번호
                            <?php echo $sound_only ?>
                        </label></th>
                    <td><input type="password" name="mb_password" id="mb_password" <?php echo $required_mb_password ?>
                        class="frm_input
                        <?php echo $required_mb_password ?>" size="30" maxlength="20">
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_3">부서1
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                        <input type="text" name="mb_3" id="mb_3" class="frm_input" size="30" maxlength="20">
                    </td>
                    <th scope="row"><label for="mb_4">부서2
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="mb_5">직책
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
                    ...
                    <th scope="row"><label for="mb_6">직급
                            <?php echo $sound_only ?>
                        </label></th>
                    <td>
        ...
        <td colspan="3"><textarea name="mb_memo" id="mb_memo"><?php echo $mb['mb_memo'] ?></textarea></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        this.form.mb_leave_date.value=this.value; } else {
                        this.form.mb_leave_date.value=this.form.mb_leave_date.defaultValue; }">
                    ...
                    <td>
                        ...
                        this.form.mb_intercept_date.value=this.value; } else {
                        this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
                                ...
                                <div class="account_provider" data-mpno="social_<?php echo $account['mp_no'];?>">
                                    <div class="sns-wrap-32 sns-wrap-over">
                                        ...
                                        <span class="provider_name">
                                            <?php echo $provider_name;   //서비스이름?> ( <?php echo $account['displayname']; ?> )</span>
                        <span class="account_hidden" style="display:none"><?php echo $account['mb_id']; ?>
                                        </span>
                                    </div>
                                    <div class="btn_info"><a
                                            ...
                                            class="sound_only">
                                            <?php echo substr($account['mp_register_day'], 2, 14); ?>
                                        </span></div>
                                </div>
                                <?php } //end foreach ?>
            </li>
