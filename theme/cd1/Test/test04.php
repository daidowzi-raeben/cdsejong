...
<div class="content-ov">
	...
	<div id="contents">
		...
		<!-- page-start // -->
		<p><img src="<?php echo G5_THEME_URL ?>/_Img/Content/test4.jpg" alt="" width="800" height="544" usemap="#Map" border="0">
          <map name="Map">
            <area shape="rect" coords="517,228,748,285" href="test04_1.php" onfocus="this.blur()" alt="인권인식 인식도 설문조사" />
          </map>
		</p>
		<!-- page-end //-->
	</div>
