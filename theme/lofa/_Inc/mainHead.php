...
<title>세종교육원</title>
    ...
    <link rel="stylesheet" type="text/css" href="_Js/engine1/style.css" />
	<script type="text/javascript" src="_Js/engine1/jquery.js"></script>
...
<div id="doc" class="isPage">
	<!-- s:	.doc-pg //-->
			<!-- s: header-Warp //-->
			<? include_once ('_Inc/headerInc.php');?>
			<!-- e : header-wrap //-->
			<!-- s: #container-wrap //-->
