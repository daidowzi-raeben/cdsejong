...
<div class="content-ov">
	...
	<div id="contents">
		...
		<table class="tbl-type01">
			...
			<tbody>
			<?php
				$cyberInfo = get_lessonApply($member['mb_id'], 12);
				$str_cyber = "미수료";
				
				if(get_int2num($cyberInfo['app_study_rate']) == 100)
				{
					$str_cyber = "수료";
				}
			?>
				<tr>
					...
					<!--<td>00000</td>
					<td>경영기획사업부</td>-->
					<td><a href="#" class="cred">나외 조직을 지키는 윤리경영 가이드라인</a></td>
					<td>2022.10.05 ~ 2022.10.31</td>
					<td>2시간</td>
					<td><?php echo $str_cyber ?></td>
					...
					<?php
						...
						{
					?>
						<a href="#n" class="cw-btn" onClick="javascript:window.open('print.php?id=<?php echo $member['mb_id']?>', 'pop01', strFeature)"><span>출력</span></a>
					<?php
						}
					?>
					</td>
