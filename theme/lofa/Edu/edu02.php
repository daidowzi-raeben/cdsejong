...
$sql_where = " where lssn_kind = 'LS02'  and lssn_company = '".$member['mb_profile']."'";
...
?>
    ...
    <div class="content-ov">
		...
		<div id="contents">
			...
			<div class="tab_menu">
				<ul>
					<li class="on"><a href="edu02.php">윤리경영 영상 메시지</a></li>
					<li><a href="edu02_02.php">청렴 영상 메시지</a></li>
					<li><a href="edu02_03.php">괴롭힘 방지법 및 예방 메시지</a></li>
				</ul>
				<p class="info_v2">윤리경영 영상 메시지는 비윤리적 사건사고, 윤리적 지식, 국내외 윤리경영 실천 사례를 감성, 공감과<br>
				재미 형식을 갖추고 지루하지 않게 짧고 임팩트 있는 메시지 형태로 제공되는 과정입니다. </p>
			</div>
			<?php 
