...
$sql_where = " where lssn_kind = 'LS22'  and lssn_company = '".$member['mb_profile']."' ";
		...
		<div id="contents">
			...
			<div class="tab_menu">
				<ul>
					...
					<li class="on"><a href="edu02_03.php">괴롭힘 방지법 및 예방 메시지</a></li>
				</ul>
				<p class="info_v4">인권 영상 메시지는 국내외 인권경영 실천 사례를 감성, 공감 과 재미 형식을 갖추고<br>
				지루하지 않게 짧고 임팩트 있는 메시지 형태로 제공되는 과정입니다.</p>
			</div>
			<?php 
