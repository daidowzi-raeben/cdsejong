...
?>
    ...
    <div class="content-ov">
		...
		<div id="contents">
			...
			<div class="tab_menu">
				<ul>
					<li class="on" style="width: 100%;"><a href="edu03.php">윤리ᆞ청렴 실천 캠페인</a></li>
				</ul>
				<p class="info_v2">윤리ᆞ청렴 실천 캠페인 교육 1. CEO 메시지, 2.윤리ᆞ청렴 메시지,3.윤리ᆞ청렴 퀴즈, 4. 내부신고안내,<br>
				5. 윤리 이야기 등 최소4-5단계 형식으로 제공되는 과정입니다. </p>
			</div>
			<?php 
