...
$sql_where = " where lssn_kind = 'LS01' and lssn_view = 'Y' ";
...
?>
    ...
    <div class="content-ov">
			...
			<div id="subNavi">
				...
				<div class="leftmenu" id="leftmenu">
					<ul class="depth2">
						...
						<li id="lm03" class='lm_l2'><a href="javascript:;"  class='lm_a2'><span class='isTxt'>캠페인 교육</span></a></li>
		...
		<div id="contents">
			...
			<!-- page-start // -->
			<p class="txt_title">사이버 이해충돌방지법 교육</p>
			<div class="edu-wrap">
				<div class="img">
					<img src="<?php echo G5_THEME_URL ?>/conflict/images/main_01.png" alt="thumbnail" />
				</div>
				<table class="table">
					<tr>
						<th>과정명</th>
						<td>공직자의 이해충돌방지법 길라잡이</td>
					</tr>
					<tr>
						<th>수료조건</th>
						<td>진도 100%</td>
				...
				<a href="#" class="class-enter"><span>학습하기</span></a>
			</div>
			<p class="txt_title">카드로 보는 갑질 개선교육</p>
			<div class="edu-wrap">
				<div class="img">
					<img src="<?php echo G5_THEME_URL ?>/gapjil/images/main_02.PNG" alt="thumbnail" />
				</div>
				<table class="table">
					<tr>
						<th>과정명</th>
						<td>카드로 보는 갑질 개선교육</td>
					</tr>
					<tr>
						<th>수료조건</th>
						<td>진도 100%</td>
			...
			<p class="txt_title">직장내 괴롭힘 예방교육</p>
			<div class="edu-wrap">
				<div class="img">
					<img src="<?php echo G5_THEME_URL ?>/torment/images/main_03.PNG" alt="thumbnail" />
				</div>
				<table class="table">
					<tr>
						<th>과정명</th>
			...
			?>
			<div class="course">
				<p class="c_img"><img src="<?php echo G5_THEME_URL ?>/_Img/Content/<?php echo $row['lssn_rimg']?>" width="237" height="178"></p>
				<ul>
					<li><span class="title">과 정 명</span><?php echo $row['lssn_title']?></li>
					<li><span class="title">수 료 조 건</span>진도 <?php echo $row['lssn_completerate']?>%, 시험 <?php echo $row['lssn_quiz_point']?>점이상 (점수미달 재시험 1회)</li>
					<li><span class="title">학 습 기 간</span><?php echo $row['lssn_sdate']?>~<?php echo $row['lssn_edate']?> (미수료자 3일 연장)</li>
