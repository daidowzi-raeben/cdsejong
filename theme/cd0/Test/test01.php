...
<div class="content-ov">
	<div id="subNavi-wrap">
		<div id="subNavi">
			...
			<div class="leftmenu" id="leftmenu">
				<ul class="depth2">
					<li id="lm01" class='lm_l2 over'><a href="test01.php"  class='lm_a2'><span class='isTxt'>윤리의식 수준지수 진단 </span></a></li>
	...
	<div id="contents">
		...
		<!-- page-start // -->
		<p><img src="<?php echo G5_THEME_URL ?>/_Img/Content/test1.jpg" alt="" width="800" height="544" usemap="#Map" border="0">
          <map name="Map">
