...
<div class="content-ov">
		...
		<div id="subNavi">
			...
			<div class="leftmenu" id="leftmenu">
				<ul class="depth2">
					...
					<li id="lm03" class='lm_l2 over'><a href="test03.php"  class='lm_a2'><span class='isTxt'>직장 내 괴롭힘 설문조사</span></a></li>
	...
	<div id="contents">
		...
		<!-- page-start // -->
		<p><img src="<?php echo G5_THEME_URL ?>/_Img/Content/test3.jpg" alt="" width="800" height="544" usemap="#Map" border="0">
          <map name="Map">
            <area shape="rect" coords="515,230,745,290" href="#" onClick="window.open('poll01_06.html','_blank','left=1,top=1,toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=825,height=880')" onfocus="this.blur()" alt="직장 내 괴롭힘 설문조사" />
          </map>
		</p>
		<!-- page-end //-->
	</div>
