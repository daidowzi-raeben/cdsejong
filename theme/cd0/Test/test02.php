...
<div class="content-ov">
		...
		<div id="subNavi">
			...
			<div class="leftmenu" id="leftmenu">
				<ul class="depth2">
					...
					<li id="lm02" class='lm_l2 over'><a href="test02.php"  class='lm_a2'><span class='isTxt'>윤리 실천자가 진단</span></a></li>
	...
	<div id="contents">
		...
		<!-- page-start // -->
		<p><img src="<?php echo G5_THEME_URL ?>/_Img/Content/test2.jpg" alt="" width="800" height="592" usemap="#Map" border="0">
          <map name="Map" id="Map">
            <area shape="rect" coords="287,158,503,203" href="#" onClick="window.open('poll02_01.html','_blank','left=1,top=1,toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=900,height=800')" onfocus="this.blur()" alt="자가진단 시작하기" />
          </map>
		</p>
		<!-- page-end //-->
	</div>
