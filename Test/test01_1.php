				...
				<li id="tm01" class="mn_l1 mn_type">
					...
					<div class="depth2-wrap"> 
						<ul class='depth2'>
							...
							<li id="tm0102" class="mn_l2"><a href="/Test/test02.php" class="mn_a2" target="_self"><span class="txt">윤리경영 의식수준 진단
</span></a></li>
...
<div class="content-ov">
	<div id="subNavi-wrap">
		<div id="subNavi">
			...
			<div class="leftmenu" id="leftmenu">
				<ul class="depth2">
					<li id="lm01" class='lm_l2 over'><a href="test01.php"  class='lm_a2'><span class='isTxt'>윤리의식 자가(자율)점검</span></a></li>
					<li id="lm02" class='lm_l2'><a href="test02.php"  class='lm_a2'><span class='isTxt'>윤리경영 의식수준 진단</span></a></li>
	...
	<div id="contents">
		...
		<!-- page-start // -->
		<p><img src="../_Img/Content/test02_02.jpg" alt="" width="800" height="592" usemap="#Map" border="0">
			<map name="Map" id="Map">
				<area shape="rect" coords="525,246,752,308" href="#" onClick="window.open('dist/report.html','_blank','left=1,top=1,toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=900,height=800')" onfocus="this.blur()" alt="자가진단 시작하기" />
			</map>
		</p>
