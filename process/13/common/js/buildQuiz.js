...
function buildQuiz(){
	...
	$(".quiz-result-correct").html("정답 : "+cur_correct);
	...
	$(".quiz-select-btn").on({
		mouseover : function(){
			$(this).children(".quiz-select-num").css({"color":"#ffd600","background-color":"#217346"});
		},
		mouseout : function(){
...
function select_fn(n){
	...
	$("#quiz-select-btn"+n).children(".quiz-select-num").css({"color":"#ffd600","background-color":"#217346"});
	submit_fn();
}
