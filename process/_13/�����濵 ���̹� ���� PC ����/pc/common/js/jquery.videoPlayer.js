;(function($){
	...
	$.fn.videoPlayer = function(options){
		...
		return this.each(function(){
			...
			controls_html += '<div id="index-open-txt">목차열기</div>';
...
*/
			...
			$rate_btn.on({
				mouseover : function(){
					if(isBrowse == "PC") $(this).css({"color":"#217346","font-family":"scd6"});
				},
				mouseout : function(){
					var _rate = parseInt($(this).attr('id').replace("rate-",""),10);
					if(_rate != curRate){
						if(isBrowse == "PC") $(this).css({"color":"#999","font-family":"scd2"});
					}
				},
				click : function(){
					var _rate = parseInt($(this).attr('id').replace("rate-",""),10);
			...
			function select_rate(n){
				...
				$("#rate-"+curRate).css({"color":"#217346","font-family":"scd6"});
			}
