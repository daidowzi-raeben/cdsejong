...
function makeUI(){
	...
	*/
	...
	$("#confirmBtn").css('background', 'url(../img/mPop.png) no-repeat center');
	...
	//$(".bottomMenu").css("top", contents_height-30); //20250605 제이제이 
	$(".bottomMenu").css("top", contents_height); //20250605 제이제이 
