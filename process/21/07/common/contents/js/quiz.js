...
function multipleQuizInit(){
	...
	$("#multipleQuiz_checkBtn").click(function() {
		...
		if(multipleQuiz_currentValue == quizData[multipleQuiz_page-1].answer){
			...
			$("#multipleQuiz_question_oxImg").css("top", "100px"); /* 2024-06-09 AI 수정: marking.png 위치를 문제번호와 같은 높이로 조정 */
...
function make_Question(){	
	...
	/* 2024-06-09 AI 수정: 문제 텍스트 위치 조정 제거 - CSS flex로 정렬하므로 불필요 */
	/*
	...
	*/
	...
	/* 2024-06-09 AI 수정: 문제 텍스트 left 위치 조정 제거 - CSS flex로 정렬하므로 불필요 */
