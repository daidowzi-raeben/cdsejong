...
function quiz_show(num) { //num번째 문제 보여주기
    ...
    if(currChasi==1 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',340); /* 보기 위치 결정 */
    if(currChasi==1 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',340); /* 보기 위치 결정 */
    if(currChasi==1 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',340); /* 보기 위치 결정 */
