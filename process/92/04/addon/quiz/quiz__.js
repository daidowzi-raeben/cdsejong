...
function quiz_show(num) { //num번째 문제 보여주기
    ...
    if(currChasi==1 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',280);
    if(currChasi==1 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',410);
    if(currChasi==2 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',390);
    if(currChasi==2 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',340);
    if(currChasi==3 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',340);
    if(currChasi==3 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',310);
    if(currChasi==3 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',210);
    if(currChasi==4 && (num==0 || num==1 )) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',330);
    if(currChasi==4 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',390);
    if(currChasi==5 && (num==0 || num==1 )) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',380);
    if(currChasi==5 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',200);
    if(currChasi==6 && (num==0 || num==2 )) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',360);
    if(currChasi==6 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',200);
    if(currChasi==9 && num==0) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',390);
    if(currChasi==10 && num==1) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',390);
    if(currChasi==10 && num==2) $("#quiz-wrapper>#quiz-content>.choice-wrapper").css('top',410);
...
function quiz_result() {
    ...
    for(i=0;i<quiz.length;i++) {
        $("#quiz-wrapper>#quiz-result>.quiz-result>thead>tr").append($("<th>").text("Q"+(i+1)));
