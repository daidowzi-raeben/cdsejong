...
var titleName = "성과를 만드는 힘, 직장윤리!";
var control_check = false;       // true : 하단 컨트롤 활성화  false : 하단 컨트롤 비활성화
...
function pageLoadComplete() {
	...
	//localStorage.setItem("lastPage", parseFloat(page));	
	//var savePage = localStorage.getItem("lastPage");
...
function nextFunc() {
	...
	document.location.href = "0"+itostr(page)+".html";	
}
