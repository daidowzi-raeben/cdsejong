...
function startVideo(url){
	videoX = 0; //chapterNames[page-1].vod_x;
	videoY = 0; //chapterNames[page-1].vod_y;
	videoW = 1280; //chapterNames[page-1].vod_w;
	videoH = 720; //chapterNames[page-1].vod_h;
	...
	$("#popupVideoCtn").hide();
	$("#videoCtn").hide();
	//alert("window.HTMLVideoElement :"+window.HTMLVideoElement);
	...
	//$("#videoCtn").css('border','1px solid red');	
	...
	//$("#video").css('left',(w/2)-(changeW/2));
	//$("#video").css('top', (h/2)-(changeH/2));
