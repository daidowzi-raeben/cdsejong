...
function quiz_show(num) { //num번째 문제 보여주기
    ...
    $("#quiz-wrapper>#quiz-content").removeClass();
    wrong_count = 0;
	...
	$("#quiz-wrapper>#quiz-content>.choice-wrapper").css({top:quiz[num].choiceposition+'px'});  
	$("#quiz-wrapper>#quiz-content>.ox-wrapper").css({top:quiz[num].choiceposition+'px'});  
