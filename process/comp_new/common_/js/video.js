...
if(thisNum == pageinfo.length) $("#toolbar>.pop-next").addClass('last');
...
$vid.on("loadedmetadata", function () {
    ...
    .css({
        ...
        background:'rgba(0,0,0,.2) url(../common/img/btn_play.png) no-repeat center',
...
$vid.on("volumechange", function () {
    ...
    $(".vol-range").height(vid.volume*100+'%');
...
function timeupdate() {
    ...
    if(vid.currentTime < vid.duration) $("#toolbar .pop-next").removeClass('on'),$("#toolbar .start_btn").removeClass('on');
