...
#echo $result['mb_id'];
if($member['mb_profile'] == '한국미쓰도요' && !$result['mb_id']) {
...
<div class="pledge-modal show" id="isShowModal">
	...
	<div class="pledge-modal--con">
		...
		<div class="con-wrap">
			<div class="logo">
				<img src="../img/mitu_logo.png" alt="logo" />
			</div>
			<div class="header">
				윤리경영 실천 서약서<br />
				<div class="sub">
					본인은 한국미쓰도요의 일원으로써 당사 경영철학인 "정도경영"의 실천
		...
		?>
<style>
#svisual-wrap,#header-wrap,#subNavi-wrap,.cont-top, #footer-wrap,.footer-wrap,.login-sub {display:none !important;}
#contents {    float: initial !important;
...
<div style="width:800px;margin:0 auto; text-align:right">
	...
	<a href="/bbs/logout.php?url=/mitu.php">로그아웃</a>
</div>
